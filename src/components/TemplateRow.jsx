// TemplateRow component - file row with checkbox for template selection
import { useState, useRef } from "react";
import { THEME as C, ACCEPTED_FILES } from "../theme/index.js";

export function TemplateRow({ p, i, onChange, onRemove, canRemove, checked, onCheck }) {
    ...
    <div style={{ display: "flex", gap: "0.4rem", alignItems: "center", marginBottom: "0.45rem" }}>
      {p.file && (
        <input
          ...
          style={{ flexShrink: 0, accentColor: C.mid }}
        />
      )}
